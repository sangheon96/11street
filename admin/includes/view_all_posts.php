...
if(isset($_POST['checkBoxArray'])) {
    ...
    foreach($_POST['checkBoxArray'] as $postValueId){
        ...
        switch($bulk_options) {
            ...
            case 'clone':
                $query = "SELECT * FROM posts WHERE post_id = {$postValueId} "; //CAN USE LIMIT #
...
?>
   <form action="" method='post'>
    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
<?php
    $query = "SELECT * FROM posts ORDER BY post_id DESC "; //CAN USE LIMIT #
...
$query = "SELECT * FROM categories WHERE cat_id = {$post_category_id}"; //CAN USE LIMIT #
...
//onClick=\"javascript: return confirm('Are you sure you want to delete?'); \" For popup of making sure!!!!!!!
?>
